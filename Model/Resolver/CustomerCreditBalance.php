 ...
 */
class CustomerCreditBalance extends AbstractStoreCreditQuery implements ResolverInterface
{
    /**
     * @inheritDoc
     */
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        ...
        if($customer_id){
            return $this->_creditManagement->getCreditBalanceByCustId($customer_id);
        }else {
